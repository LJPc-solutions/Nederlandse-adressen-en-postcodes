...
![Adressen](https://img.shields.io/badge/adressen-9.671.814-brightgreen) ![Laatste update](https://img.shields.io/badge/laatste%20update-11--10--2025-brightgreen)
...
- adressen.tar.xz (1.0GB uitgepakt): dit archief bevat een CSV-bestand met daarin van alle adressen de volgende gegevens:
    ...
    - Latitude
    - Longitude
- provincies.tar.xz (934.7MB uitgepakt): dit archief bevat CSV-bestanden van alle adressen, gesplitst per provincie.
