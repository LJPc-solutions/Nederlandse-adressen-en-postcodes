...
![Adressen](https://img.shields.io/badge/adressen-9.662.500-brightgreen) ![Laatste update](https://img.shields.io/badge/laatste%20update-06--09--2025-brightgreen)
...
- adressen.tar.xz (1.0GB uitgepakt): dit archief bevat een CSV-bestand met daarin van alle adressen de volgende gegevens:
    ...
    - Latitude
    - Longitude
- provincies.tar.xz (933.8MB uitgepakt): dit archief bevat CSV-bestanden van alle adressen, gesplitst per provincie.
