...
![Adressen](https://img.shields.io/badge/adressen-9.636.808-brightgreen) ![Laatste update](https://img.shields.io/badge/laatste%20update-10--05--2025-brightgreen)
...
- adressen.tar.xz (1.0GB uitgepakt): dit archief bevat een CSV-bestand met daarin van alle adressen de volgende gegevens:
    ...
    - Latitude
    - Longitude
- provincies.tar.xz (931.3MB uitgepakt): dit archief bevat CSV-bestanden van alle adressen, gesplitst per provincie.
