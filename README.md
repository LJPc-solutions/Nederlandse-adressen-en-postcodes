...
![Adressen](https://img.shields.io/badge/adressen-9.659.754-brightgreen) ![Laatste update](https://img.shields.io/badge/laatste%20update-09--08--2025-brightgreen)
...
- adressen.tar.xz (1.0GB uitgepakt): dit archief bevat een CSV-bestand met daarin van alle adressen de volgende gegevens:
    ...
    - Latitude
    - Longitude
- provincies.tar.xz (933.6MB uitgepakt): dit archief bevat CSV-bestanden van alle adressen, gesplitst per provincie.
