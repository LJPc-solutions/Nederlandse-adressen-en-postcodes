...
![Adressen](https://img.shields.io/badge/adressen-9.629.780-brightgreen) ![Laatste update](https://img.shields.io/badge/laatste%20update-05--04--2025-brightgreen)
...
- adressen.tar.xz (1.0GB uitgepakt): dit archief bevat een CSV-bestand met daarin van alle adressen de volgende gegevens:
    ...
    - Latitude
    - Longitude
- provincies.tar.xz (930.6MB uitgepakt): dit archief bevat CSV-bestanden van alle adressen, gesplitst per provincie.
